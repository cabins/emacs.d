;;; tenon-dark-theme.el --- a complete port of the Tenon Dark theme for Emacs

;; Copyright (C) 2021, Cabins
;; Author: Cabins
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'tenon-dark
   `(default                                  ((,class (:background ,bg1 :foreground "gray"))))
   ...
   `(org-level-1                              ((,class (:bold nil :foreground ,keyword :height 1.1))))
