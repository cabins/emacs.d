;;; tenon-light-theme.el --- Awesome Emacs color theme on white background
;;; Commentary:
;;; Code:

(deftheme tenon-light
...
(let ((class '((class color) (min-colors 89)))
      ...
      (highlight-line-gnus '(:background "#DAEAFC")) ; defined in `gnus-tenon-light.el'
      ...
      (string '(:foreground "#b5111c")) ; or #D0372D
  ...
  (custom-theme-set-faces
   ...
   ;; Mode line faces
   `(mode-line ((,class (:foreground "white" :background "#177bc9"))))
   `(mode-line-inactive ((,class (:foreground "#F0F0EF" :background "#177bc9"))))
   ...
   `(font-lock-constant-face ((,class (:foreground "#0e12f9"))))
   `(font-lock-doc-face ((,class (:foreground "#a9121b"))))
   ...
   `(company-tooltip ((,class (:background "#f3f3f3"))))
   `(company-scrollbar-bg ((,class (:background "#f3f3f3"))))
   ...
   `(ivy-current-match                        ((t (:background "#177bc9" :foreground "white" :extend t))))
...
(custom-theme-set-variables 'tenon-light
...
;;; tenon-light-theme.el ends here
